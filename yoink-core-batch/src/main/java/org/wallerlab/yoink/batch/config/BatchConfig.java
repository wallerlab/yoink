...
public class BatchConfig {
	...
	public Step serviceStep(StepBuilderFactory stepBuilderFactory, ItemReader<List<File>> cmlFilesRequest,
			ItemProcessor<List<File>, List<org.wallerlab.yoink.batch.api.model.bootstrap.Job>> adaptiveQMMMProcessor,
			ItemWriter<List<org.wallerlab.yoink.batch.api.model.bootstrap.Job>> cmlFilesResponse) {
		return stepBuilderFactory.get("adaptiveQMMM").<List<File>, List<org.wallerlab.yoink.batch.api.model.bootstrap.Job>> chunk(1)
	...
	public Step batchStep(StepBuilderFactory stepBuilderFactory, ItemReader<Cml> cmlFilereader,
			ItemProcessor<JAXBElement, org.wallerlab.yoink.batch.api.model.bootstrap.Job> serialAdaptiveQMMMProcessor,
	...
	public Step jmsStep(StepBuilderFactory stepBuilderFactory) {
		return stepBuilderFactory.get("adaptiveQMMMJms").<String, org.wallerlab.yoink.batch.api.model.bootstrap.Job> chunk(1)
				.reader(jmsRequestReader())
				.processor((ItemProcessor<String, org.wallerlab.yoink.batch.api.model.bootstrap.Job>) appContext
	 ...
	 */
	@Bean
	ItemWriter<org.wallerlab.yoink.batch.api.model.bootstrap.Job> jmsJobItemWriter() {
