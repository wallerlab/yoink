...
public class VoronoiCalculator implements Calculator<Map<String, Object>, Coord, Set<Molecule>> {
	...
	private void loopOverAllMoleculesInRegion(List<Atom> twoNeighbours,
											  ...
											  List<Molecule> twoMolecules) {
		//TODO bottleneck
		for (Molecule molecule : molecules) {
			for (Atom atom : molecule.getAtoms()) {
				double distanceBetweenGridPointToAtom = tempCoord.getCoords().distance(atom.getCoordinate().getCoords());
				getTwoClosestNeighbours(twoNeighbours, neighbourDistances, atom, distanceBetweenGridPointToAtom, twoMolecules, molecule);
			}
		}
	}
