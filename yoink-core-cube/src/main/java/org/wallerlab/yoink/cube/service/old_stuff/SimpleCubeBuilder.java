...
public class SimpleCubeBuilder implements CubeBuilder<Set<Molecule>> {
	...
	public Cube build(double[] xyzStepSize, Set<Molecule> molecules) {
		...
		getMinMax(xCoordOfAllMolecules, yCoordOfAllMolecules, zCoordOfAllMolecules, cube, xyzMinimumOfCube, xyzMaximumOfCube);
	...
	private List<Coord> getAllCoordinates(Cube cube) {
		...
		System.out.println("x , y z are : " + cube.getNumberOfXYZSteps()[0] +" " + cube.getNumberOfXYZSteps()[1]  + " " +  cube.getNumberOfXYZSteps()[2] +" ");
