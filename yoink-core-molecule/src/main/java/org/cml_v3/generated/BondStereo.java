...
public class BondStereo {
	...
	protected String conventionValue;
	@XmlAttribute(name = "id")
	protected String id;
	@XmlAttribute(name = "title")
	protected String title;
	@XmlAttribute(name = "atomRefArray")
	protected List<String> atomRefArray;
	 ...
	 * 
	 * 
	 * @return possible object is {@link StereoType }
	 * 
	 */
	public StereoType getValue() {
		return value;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link StereoType }
	 * 
	 */
	public void setValue(StereoType value) {
		this.value = value;
	}
	 ...
	 * 
	 */
	public void setConventionValue(String value) {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the atomRefArray property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 */
	public List<String> getAtomRefArray() {
		if (atomRefArray == null) {
			atomRefArray = new ArrayList<String>();
		}
