...
public class BondArray {
	...
	protected java.util.List<String> atomRef2;
	@XmlAttribute(name = "title")
	protected String title;
	@XmlAttribute(name = "bondID")
	protected java.util.List<String> bondID;
	...
	protected java.util.List<String> atomRef1;
	@XmlAnyAttribute
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the atomRef2 property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 */
	public java.util.List<String> getAtomRef2() {
		if (atomRef2 == null) {
			atomRef2 = new java.util.ArrayList<String>();
		}
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the bondID property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 */
	public java.util.List<String> getBondID() {
		if (bondID == null) {
			bondID = new java.util.ArrayList<String>();
		}
		return this.bondID;
	}
	...
	public java.util.List<String> getOrder() {
		if (order == null) {
			order = new java.util.ArrayList<String>();
		}
		return this.order;
	}
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the atomRef1 property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 */
	public java.util.List<String> getAtomRef1() {
		if (atomRef1 == null) {
			atomRef1 = new java.util.ArrayList<String>();
		}
