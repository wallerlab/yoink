...
public class Join {
	...
	protected java.util.List<String> moleculeRefs2;
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the moleculeRefs2 property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 */
	public java.util.List<String> getMoleculeRefs2() {
		if (moleculeRefs2 == null) {
			moleculeRefs2 = new java.util.ArrayList<String>();
		}
