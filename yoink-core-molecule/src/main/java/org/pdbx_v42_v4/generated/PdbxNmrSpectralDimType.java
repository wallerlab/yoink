...
public class PdbxNmrSpectralDimType {
    ...
    public static class PdbxNmrSpectralDim {
        ...
        @XmlElementRef(name = "encoded_source_dimension_id", namespace = "http://pdbml.pdb.org/generated/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> encodedSourceDimensionId;
        @XmlElementRef(name = "encoding_code", namespace = "http://pdbml.pdb.org/generated/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<String> encodingCode;
        @XmlElementRef(name = "magnetization_linkage_id", namespace = "http://pdbml.pdb.org/generated/pdbx-v42.xsd", type = JAXBElement.class, required = false)
        protected JAXBElement<BigInteger> magnetizationLinkageId;
        @XmlElementRef(name = "sweep_width", namespace = "http://pdbml.pdb.org/generated/pdbx-v42.xsd", type = JAXBElement.class, required = false)
