 ...
 */
package org.wallerlab.yoink.region.service.regionizer.density;
 ...
 */
@Service
public class DensityRegionizer implements Regionizer<Map<Region.Name, Region>, Map<JobParameter, Object>> {
	...
	/*
	 * get all region density(adaptive qm core, adaptive qm and buffer
