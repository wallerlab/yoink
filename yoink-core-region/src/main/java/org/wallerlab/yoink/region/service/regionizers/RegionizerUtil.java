 ...
 */
package org.wallerlab.yoink.region.service.regionizers;
...
public class RegionizerUtil implements RegionizerMath<Map<Region.Name, Region>, MolecularSystem> {
	 ...
	 */
	@Override
	public Map<Region.Name, Region> regionize(Map<Region.Name, Region> regions, MolecularSystem molecularSystem) {
		for (Region.Name name : regionNames) {
			...
			case NONQM_CORE:
				...
				break;
			case NON_QM_CORE_ADAPTIVE_SEARCH:
				region = singleRegionizerService.regionize(regions, NON_QM_CORE_ADAPTIVE_SEARCH);
				break;
			default:
	 ...
	 */
	private Region qmCoreFixedRegionize(Region.Name name, MolecularSystem molecularSystem) {
