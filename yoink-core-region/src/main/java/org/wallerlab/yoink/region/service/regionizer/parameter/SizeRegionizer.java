 ...
 */
@Service
public class SizeRegionizer extends ParameterRegionizer {

	@Resource
	private Calculator<Map<Molecule, Double>, Coord, Set<Molecule>> sortedCalculator;
	...
	protected void checkEveryNonQMCoreMolecule(Region qmAdaptiveRegion,
		 ...
		 */
		Map<Molecule, Double> distanceAndMoleculeSequence = sortedCalculator.calculate(centerCoord, nonQMCoreMolecules);
		...
		checkCriteria(qmAdaptiveRegion, bufferRegion, distanceAndMoleculeSequence, qmNumber, distance_s_qm_in, distance_t_qm_out);
